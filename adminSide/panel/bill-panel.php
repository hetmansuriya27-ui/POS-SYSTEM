            ...
            <div class="m-50">
                <div class="mt-5 mb-3">
                    ...
                    <form method="POST" action="#">
                        <div class="row">
                            <div class="col-md-6">
                                <input required type="text" id="search" name="search" class="form-control" placeholder="Enter Bill ID, Table ID, Card ID, Payment Method, Order Source">
                            </div>
                            <div class="col-md-3">
                ...
                if (isset($_POST['search'])) {
                    if (!empty($_POST['search'])) {
                        ...
                        $sql = "SELECT * FROM Bills 
                                WHERE table_id LIKE '%$search%' OR payment_method LIKE '%$search%' OR bill_id LIKE '%$search%' OR card_id LIKE '%$search%' OR order_source LIKE '%$search%' 
                ...
                if ($result = mysqli_query($link, $sql)) {
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "<td>" . htmlspecialchars($row['order_source']) . "</td>";
