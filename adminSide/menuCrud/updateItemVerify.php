...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // User-provided input
    $provided_account_id = trim($_POST['admin_id'] ?? ''); // Replace with your admin account ID
    $provided_password = trim($_POST['password'] ?? ''); // Replace with your admin account password
