...
if (isset($_SESSION['logged_account_id'])) {
    ...
    if ($admin_check_res && $admin_check_row = mysqli_fetch_assoc($admin_check_res)) {
        if ($admin_check_row['role'] == 'Admin') {
            header("Location: ../menuCrud/createItem.php");
            exit();
        }
    }
}
...
<body>
    <div class="login-container">
        ...
        <h5 class="panel-subtitle">Admin Credentials needed to Add Item</h5>
        ...
        <form action="" method="post" autocomplete="off">
            ...
            <div class="form-group mt-2">
                <button class="btn btn-submit mb-3" type="submit" name="submit" value="submit">Add Item</button>
