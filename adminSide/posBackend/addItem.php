    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_query($link, $update_quantity_sql)) {
                ...
                $update_kitchen_sql = "UPDATE Kitchen SET quantity = quantity + $quantity, time_submitted = '$currentTime' WHERE table_no = '$table_id' AND item_id = '$item_id'";
            ...
            $insert_kitchen_sql = "INSERT INTO Kitchen (table_no, item_id, quantity, time_submitted) VALUES ('$table_id', '$item_id', '$quantity', '$currentTime')";
