        ...
        <div id="insert-reservation-into-table"><br>
                    ...
                    <form id="reservation-form" method="POST" action="insertReservation.php" class="ht-600 w-50">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="customer_name" name="customer_name" class="form-control" required placeholder="Customer Name"><br>
                        </div>
                        
                        <div class="form-group">
                            <label for="phone_number">Mobile Number</label><br>
                            <input type="text" id="phone_number" name="phone_number" class="form-control" required placeholder="Mobile Number"><br>
                        </div>
                        <?php
