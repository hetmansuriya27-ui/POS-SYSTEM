...
if (isset($_SESSION['logged_account_id'])) {
    ...
    if ($admin_check_res && $admin_check_row = mysqli_fetch_assoc($admin_check_res)) {
        if ($admin_check_row['role'] == 'Admin') {
            header("Location: ../reservationsCrud/createReservation.php");
            exit();
        }
    }
}
...
<body>
    <div class="login-container">
        ...
        <h5 class="panel-subtitle">Admin Credentials needed to Add Reservation</h5>
        ...
        <form action="" method="post" autocomplete="off">
            ...
            <div class="form-group mt-2">
                <button class="btn btn-submit mb-3" type="submit" name="submit" value="submit">Add Reservation</button>
                <a class="btn btn-cancel d-block text-center" href="../panel/reservation-panel.html" >Cancel</a>
            </div>
        </form>
    </div>
