            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card form-card">
                    <div class="card-header card-header-dark">
                        <h3><i class="fa fa-key mr-2"></i> Create New Account</h3>
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="success_create_staff_Account.php">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input min="1" type="number" name="account_id" placeholder="e.g. 100001" class="form-control form-control-custom <?php
...
require_once '../posBackend/checkIfLoggedIn.php'; echo $account_id; ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="email" name="email" placeholder="e.g. staff12@xhotel.com" class="form-control form-control-custom <?php
...
require_once '../posBackend/checkIfLoggedIn.php'; echo date('Y-m-d'); ?>">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="phone_number" placeholder="e.g. +60101231234" class="form-control form-control-custom <?php
...
require_once '../posBackend/checkIfLoggedIn.php'; echo $phone_number; ?>">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <div class="input-group">
                                    <input type="password" name="password" placeholder="••••••••" id="password" required class="form-control form-control-custom <?php
